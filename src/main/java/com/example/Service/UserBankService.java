...
//    private static final Logger logger = LoggerFactory.getLogger(UserBankService.class);
    ...
    public UserBank findById(int id) {
    	return userBankRepository.findById(id).orElse(null);
    }
    
    public List<UserBank> findAllByUserId(int userId){
    	return userBankRepository.findAllByUserId(userId);
    }
